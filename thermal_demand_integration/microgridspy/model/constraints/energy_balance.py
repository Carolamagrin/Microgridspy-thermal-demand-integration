...
def add_lost_load_constraint(
    ...
    for year in years:
        ...
        if has_compressor and has_tes:
            ...
            extra_electric_demand = 0 * var['lost_load'].sel(years=year)

        model.add_constraints(
            var['lost_load'].sel(years=year) - lost_load_fraction * extra_electric_demand
            <= lost_load_fraction * base_electric_demand,
